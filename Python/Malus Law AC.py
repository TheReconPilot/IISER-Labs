...
plt.annotate(r'$\rm I = 112.622\ \cos^2 (\theta+3.954)$', 
             xy = (0.05, 0.92), xycoords = "axes fraction", bbox = bbox_props)              
plt.annotate(r'$\rm R^2 = 0.989$', 
             xy = (0.05, 0.81), xycoords = "axes fraction", bbox = bbox_props)
plt.title("Anti-Clockwise")
plt.show()
#plt.savefig("AntiClockwise.png")